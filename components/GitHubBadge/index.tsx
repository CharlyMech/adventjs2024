...
export function GitHubBadge({ githubUrl }: { githubUrl: string }) {
	return (
		<Link href={githubUrl} target="_blank">
			{/* <div className="flex items-center space-x-2 h-[36px] w-auto rounded-[8px] shadow-lg bg-[#0E1217]">
				<div className="h-[36px] w-[36px] rounded-[8px] bg-white p-1 flex items-center justify-center">
